  ...
  <form name="fadd" method="post" action="<?php echo U('save');?>" enctype="multipart/form-data">
    <ul class="forminfo">
      ...
      <li class="beifen">
        ...
        <i>备份公众号的Appid</i></li>
      <li class="beifen">
        <label>备份AppSecret</label>
        <input name="cbeiappsecret" type="text" value="<?php echo ($sysconfig['cbeiappsecret']); ?>" class="dfinput" />
        <i>备份AppSecret</i></li>
      <li class="beifen">
        <label>开启备份收款</label>
        <cite> <input name="cbeipay" type="checkbox" value="2" <?php if(($sysconfig['cbeipay']) == "2"): ?>checked<?php endif; ?> > 
        <i>勾选，备份公众号收款</i></cite></li>
      <li class="beifen">
        <label>备份商户号</label>
        <input name="cbeimchid" type="text" value="<?php echo ($sysconfig['cbeimchid']); ?>" class="dfinput" />
        <i>备份公众号的商户号</i></li>
      <li class="beifen">
        <label>备份商户密钥</label>
        <input name="cbeiappkey" type="text" value="<?php echo ($sysconfig['cbeiappkey']); ?>" class="dfinput" />
        <i></i></li>
      <li>
        <label>&nbsp;</label>
